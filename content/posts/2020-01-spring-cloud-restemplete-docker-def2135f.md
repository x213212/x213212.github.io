...
```
eureka: client: serviceUrl: defaultZone: http://localhost:8761/eureka/ register-with-eureka : true <====就是這行 讓我們的 的 服務可以去請求其他已經註冊的伺服器
```
...
```
@FeignClient(value ="eureka-provider2",fallbackFactory=HystrixClientFallbackFactory.class) public interface HomeClient { @GetMapping("/ep2") public String home(@RequestParam (value="id", required = false) Integer employeeId,@RequestParam (value="id2", required = false) Integer employeeId2) ; }
```
...
前面步驟就不說了 ![](https://i.imgur.com/dm2GHVg.png) 可以看到我訪問的是 helloEx
...
![](https://i.imgur.com/937NaX4.png) 服務啟動 ![](https://i.imgur.com/DRqjfjS.png) ![](https://i.imgur.com/iARveAz.png) 好了之後 我們的追蹤鏈也很清楚 ![](https://i.imgur.com/4TdzDv6.png)
