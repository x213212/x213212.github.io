...
這邊可以看到我們的 新增了一個 p指標 並呼叫 ParserNew 去初始化我們的 指標 *p 並呼叫我們的ParserParse 開始解析
```
#include "Parser.h"
...
```
實際上就是 Scanner.c 裡面定義好的函式，主要就是對我們讀入的 當前 text 去做拆分  
...
可以知道我們需要走next 這個函式 才能進到下一層 parserExp§  
