...
<https://blog.csdn.net/qq_37525899/article/details/81132069> 在不破壞結構的狀態下 進行後端移植table 觀察官方 預設返回的結構後 ![](https://i.imgur.com/S00Ojwx.png) 需要注意一點，在 List 的 變數 需要 在 初始化 的時候指定為

```
new ArrayList<>()
```

<https://stackoverflow.com/questions/43705582/java-lang-unsupportedoperationexception-adding-to-a-list> 然後 就是 編寫 java object to json 的寫法

```
http://localhost:9990/httpMethod2
```

![](https://i.imgur.com/CfMgGe7.png) ![](https://i.imgur.com/qt7c8EZ.png) ![](https://i.imgur.com/NOx4e6c.png) 收工， 接下來要詳細針對 個別控件 透過 vue routuer 進行傳值的詳細分析，預計大概五天
