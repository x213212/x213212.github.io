...
def nav(config: dict[str, Any], current: str) -> str:
  ...
  <div class="site-header__inner">
    ...
    <a class="github-link" href="{html.escape(str(config['github_url']), quote=True)}" target="_blank" rel="noopener">GitHub ↗</a>
  </div>
</header>'''
...
<body>
  ...
  <footer class="site-footer">
    ...
    <div>Legacy theme image by <a href="https://www.istockphoto.com/portfolio/AndrzejStajer" target="_blank" rel="noopener">AndrzejStajer</a> · Static archive{visitor_counter(config)}</div>
  </footer>
